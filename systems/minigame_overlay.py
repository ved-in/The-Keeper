...
# registered minigames: { key: minigame }
_registry: dict = {}
...
def register(key: str, minigame) -> None:
    _registry[key] = minigame
...
def draw(screen: pygame.Surface) -> None:
    ...
    # content was drawn before sliding making it look ahhh
    # this will fix it
    if _slide_t >= 1.0 and _active_key:
