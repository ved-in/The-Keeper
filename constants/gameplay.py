...
NEGLECT_MAX = 100.0
NEGLECT_DAY_RATE = 4.9
NEGLECT_DAY_END_PENALTY = 12.0
NEGLECT_BEACH_IDLE_RATE = 0.8
NEGLECT_BEACH_CARRY_RATE = 0.35
NEGLECT_NIGHT_EMERGENCY_RATE = 6.5
NEGLECT_DAY_NIGHT_RATE = 0.75
NEGLECT_DAY_NIGHT_EMERGENCY_RATE = 4.5
NEGLECT_STABILITY_RELIEF = 2.5
NEGLECT_TASK_RELIEF = 9.0
NEGLECT_EMERGENCY_RELIEF = 10.0

NEGLECT_FAILURE_TITLE = "The Light Goes Dark"
NEGLECT_FAILURE_DEFAULT = "Too much was left unanswered. The lighthouse slips out of your hands."
